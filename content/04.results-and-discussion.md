...
Small chemical changes to molecules can drastically alter their electronic property.
...
Seemingly similar torsions in different chemical environments can have very different torsion potential.
This is particularly apparent in conjugated systems where small, remote changes can exert strong electron-donating or -withdrawing effects thus altering torsional barrier heights.
...
We illustrate such changes in an example as shown in [hold for figure]

[Biphenyl example with florine  and chlorine substituent?]`{.yellow}`
